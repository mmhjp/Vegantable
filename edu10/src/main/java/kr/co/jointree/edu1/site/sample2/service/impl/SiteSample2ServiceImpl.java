...
public class SiteSample2ServiceImpl implements SiteSample2Service {
    ...
    public int addComment(Map<String, Object> paramMap) {
    	int selectData = siteSample2DAO.addComment(paramMap);
        return selectData;
    }
     ...
     * @return
     */
    public Map<String, Object> getCommentList(Map<String, Object> paramMap) {
    	Map<String, Object> getComment= new HashMap<>();
    	List<Map<String, Object>> getCommentList = siteSample2DAO.getCommentList(paramMap);
    	getComment.put("getCommentList", getCommentList);
    ...
    //댓글삭제
    public int setCommentDelete(Map<String, Object> paramMap) {
    	int selectData = siteSample2DAO.setCommentDelete(paramMap);
        return selectData;
