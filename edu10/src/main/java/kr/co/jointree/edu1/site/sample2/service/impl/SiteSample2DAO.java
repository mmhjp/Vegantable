...
public class SiteSample2DAO extends EgovComAbstractDAO {
    ...
    int addComment(Map<String, Object> paramMap) {
    	return insert("SiteSample2DAO.addComment", paramMap);
    }
    //댓글조회
    List<Map<String, Object>> getCommentList(Map<String, Object> paramMap){
        return selectList("SiteSample2DAO.getCommentList", paramMap);
    }
    //댓글삭제
    int setCommentDelete(Map<String, Object> paramMap) {
    	return update("SiteSample2DAO.setCommentDelete", paramMap);
    }
