...
-->
	...
	<div class="col-md-10" >
		...
		<!-- 검색입력 -->
		<div class="row mb-3">
			<form id="registForm" class="join-form"
				action="/sample1/form-save.do" method="post">
				<input type="hidden" id="regist_id" name="regist_id"
					value="<c:out value="${id}"/>"> <input type="hidden"
					id="post_seq" name="post_seq"
					value="<c:out value="${paramMap.post_seq }"/>">

				<div class="col-12 mb-3">
					<label for="post_title" class="form-label">제목 <span
						class="text-danger">*</span></label> <input type="text" id="post_title"
						name="post_title" class="form-control" placeholder="제목을 입력해 주세요."
						value="">
				</div>

				<div class="col-12 mb-3">
					<label for="post_title" class="form-label">내용 <span
